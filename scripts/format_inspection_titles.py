...
# BRAND_NAMES = ["Aid", "Splenda", "Fiji", "Ziploc", "BBQ"]

# # Lista de preposiciones a mantener en minúsculas
# PREPOSITIONS = ["de", "la", "con", "para", "y", "el", "del", "al"]
...
#     for tag in soup.find_all('h3', class_=['titulo-principal', 'subtitulo', 'subtitulo2']):
